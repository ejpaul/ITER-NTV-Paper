...
\end{gather}
Note that this is similar to the form presented by Sugama \cite{Sugama2016}, except for we have chosen a different form of regularization. We compare this form with the `Full Magnetic Drifts,' as given in eq. \ref{kineticequation}. 
